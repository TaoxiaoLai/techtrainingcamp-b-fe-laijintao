...
module.exports = {
  ...
  */
  head: {
    ...
    link: [// { rel: 'preconnect', href: 'http://localhost:3000/search/searchList/' },
...
/* harmony import */ var _utils_axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/axios */ "./server/interface/utils/axios.js");
...
const CACHED = new lru_cache__WEBPACK_IMPORTED_MODULE_1___default.a({
  max: 100,
  // 缓存队列长度
  maxAge: 1000 * 60 // 缓存时间
...
router.get('/searchList', async ctx => {
  ...
  let {
    status,
    data
  } = await _utils_axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(`https://i.snssdk.com/search/api/sug/?keyword=${keyword}`);
